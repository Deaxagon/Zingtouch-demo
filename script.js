...
var regionthree=new ZingTouch.Region(tapElementThree,true,false);
regionthree.bind(tapElementThree, Rotate, function(e){
  setOutput([
    ['Gesture', 'rotated'],
    ['inputs' , '1'],
    ['interval', Math.floor(e.detail.interval) + "ms"]
  ...
  tapElementThree.style.backgroundColor='red';
  (function(element){
    setTimeout(function(){
      element.innerHTML =  "Rotate the bubble";
      tapElementThree.style.backgroundColor='lightgreen';
    }, 1000);
  })(textElement);
})
